...
login(token="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")
...
def create_llms_model():
    llm = CTransformers(model="mistral-7b-instruct-v0.2.Q4_K_M.gguf", config={'max_new_tokens': 128, 'temperature': 0.01})
    return llm
